...
public class BiomeGenBase extends BiomeBase {
	...
	public static final BiomeGenBase swampland = new BiomeGenSwamp(1).b(8362784).a(
			BiomeBase.SWAMPLAND.y).
			a(9154376);
	public static final BiomeGenBase seasonalForest = new BiomeGenBase(4).b(10215459).a(
			"Seasonal Forest");
	public static final BiomeGenBase forest = new BiomeGenForest(4).b(353825).a(BiomeBase.FOREST.y).
			a(5159473);
	...
	public static final BiomeGenBase taiga = new BiomeGenTaiga(5).b(3060051).a(BiomeBase.TAIGA.y).
			b().a(
			8107825);
	public static final BiomeGenBase desert = new BiomeGenDesert(2).b(16421912).
			a(BiomeBase.DESERT.y).m();
