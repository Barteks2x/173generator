...
public class BiomeGenBase extends BiomeBase
{
    ...
    public static final BiomeGenBase   rainforest       = new BiomeGenRainforest(21).b(588342).a("Rainforest").a(2094168);
    public static final BiomeGenBase   swampland	= new BiomeGenSwamp(1).b(8362784).a("Swampland").a(9154376);
    public static final BiomeGenBase   seasonalForest   = new BiomeGenBase(4).b(10215459).a("Seasonal Forest");
    public static final BiomeGenBase   forest	   = new BiomeGenForest(4).b(353825).a("Forest").a(5159473);
    public static final BiomeGenBase   savanna	  = new BiomeGenDesert(1, false).b(14278691).a("Savanna");
    public static final BiomeGenBase   shrubland	= new BiomeGenBase(1).b(10595616).a("Shrubland");
    public static final BiomeGenBase   taiga	    = new BiomeGenTaiga(5).b(3060051).a("Taiga").b().a(8107825);
    public static final BiomeGenBase   desert	   = new BiomeGenDesert(2, false).b(16421912).a("Desert").m();
