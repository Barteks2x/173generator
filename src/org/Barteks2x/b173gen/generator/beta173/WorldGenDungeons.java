...
public class WorldGenDungeons extends WorldGenerator
{
	...
	for (int k1 = i - l - 1; k1 <= i + l + 1; k1++)
	{
		...
		for (int i3 = k - i1 - 1; i3 <= k + i1 + 1; i3++)
		{
		    ...
		    if ((k1 == i - l - 1 || k1 == i + l + 1 || i3 == k - i1 - 1 || i3 == k + i1 + 1) && j2 == j && world.getMaterial(k1, j2, i3) == Material.AIR && world.getMaterial(k1, j2 + 1, i3) == Material.AIR)
		    {
			j1++;
		    }
		}
	...
	for (int l1 = i - l - 1; l1 <= i + l + 1; l1++)
	{
		...
		for (int j3 = k - i1 - 1; j3 <= k + i1 + 1; j3++)
		{
		    ...
		    {
			if (k2 >= 0 && !world.getMaterial(l1, k2 - 1, j3).isSolid())
			{
